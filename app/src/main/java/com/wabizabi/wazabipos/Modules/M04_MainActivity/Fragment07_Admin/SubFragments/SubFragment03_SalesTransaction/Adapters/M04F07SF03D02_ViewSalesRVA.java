...
public class M04F07SF03D02_ViewSalesRVA extends RecyclerView.Adapter<M04F07SF03D02_ViewSalesRVA.ViewHolder> {
    ...
    public M04F07SF03D02_ViewSalesRVA(Context context, Realm realm, List<CartItem> listOfItems, Map<CartItem, Integer> mapOfItems) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutHelper.inflateRV(parent, R.layout.act04_main_frag07_admin_subfrag03_salestransaction_dg02_viewsales_rvlayout);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            itemQty = itemView.findViewById(R.id.M04F07SF03D02_RVItemQty);
            itemName = itemView.findViewById(R.id.M04F07SF03D02_RVItemName);
            itemPrice = itemView.findViewById(R.id.M04F07SF03D02_RVItemPrice);
            itemDiscount = itemView.findViewById(R.id.M04F07SF03D02_RVDiscountName);
            itemDiscountPercentage = itemView.findViewById(R.id.M04F07SF03D02_RVDiscountPercentage);
            itemDiscountPrice = itemView.findViewById(R.id.M04F07SF03D02_RVDiscountAmount);
            itemTotal = itemView.findViewById(R.id.M04F07SF03D02_RVItemTotalPrice);
        }
