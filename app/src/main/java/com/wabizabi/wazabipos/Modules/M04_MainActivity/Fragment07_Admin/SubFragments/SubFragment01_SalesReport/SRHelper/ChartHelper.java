...
public class ChartHelper {
    ...
    public static List<SalesTransaction> getDailyView(Realm realm, String year, String month, String day){
        List<SalesTransaction> listOfSales = new ArrayList<>();
        RealmResults<RealmSalesTransaction> queriedSales = realm.where(RealmSalesTransaction.class)
                .equalTo("year", year)
                .and()
    ...
    public static List<BarEntry> getDailySales(Realm realm, String year, String month, String day){
