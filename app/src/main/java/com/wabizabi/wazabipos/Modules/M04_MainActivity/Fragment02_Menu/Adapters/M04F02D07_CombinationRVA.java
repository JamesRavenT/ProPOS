...
public class M04F02D07_CombinationRVA extends RecyclerView.Adapter<M04F02D07_CombinationRVA.ViewHolder> {

    List<List<String>> itemsets;

    public M04F02D07_CombinationRVA(List<List<String>> itemsets) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.act04_main_frag02_menu_dg07_viewitem_rvlayout, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            itemSetNo = itemView.findViewById(R.id.M04F02D07_RVCombinationText);
            itemSetItems = itemView.findViewById(R.id.M04F02D07_RVItemSet);
        }
